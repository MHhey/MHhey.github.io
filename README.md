...
A supplement to your CS/AI résumé when applying to construction tech companies. It is deliberately
**not** your CV. Someone at Doxel, Kaya, Krane or Mortenson has your résumé open in another tab and
30 seconds here — they want to see that you can build, and that you know the domain.
...
- Hero animation: the bullwhip effect from your research — a steady signal at the Owner amplifying
  into erratic swings by the Supplier, computed live in ~60 lines of inline JS. Falls back to a
  static wave under `prefers-reduced-motion`, pauses when the tab is hidden, and is hidden in print.
